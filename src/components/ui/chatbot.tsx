    ...
    return (
      <div className="fixed bottom-4 right-4 z-50">
        <Button 
          ...
          className="bg-quickfix-orange hover:bg-quickfix-orange/90 rounded-full p-4 h-16 w-16 flex items-center justify-center shadow-lg"
        >
      ...
      <Card className="w-80 md:w-96 h-[500px] shadow-lg flex flex-col">
        ...
        <div className="p-3 border-t flex">
          ...
          <Button 
            onClick={handleSend} 
            disabled={loading} 
            className="ml-2 bg-quickfix-blue hover:bg-quickfix-blue/90"
          >
