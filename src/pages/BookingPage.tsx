        ...
        <div className="container mx-auto px-4 py-12 relative">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative z-10">
            ...
            <div className="space-y-6">
              ...
              {/* Why Choose Us */}
              <div className="bg-quickfix-light-blue rounded-lg shadow-md p-6 relative overflow-hidden">
              ...
              {/* Emergency Service */}
              <div className="bg-quickfix-orange/10 border border-quickfix-orange rounded-lg p-6 relative overflow-hidden">
                <RetroGrid className="opacity-15" />
                <div className="relative z-10">
